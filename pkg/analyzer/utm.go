...
func (utm *UTM) Source(filter *Filter) ([]model.UTMSourceStats, error) {
	ctx, q, args := utm.analyzer.selectByAttribute(filter, FieldUTMSource)
...
func (utm *UTM) Medium(filter *Filter) ([]model.UTMMediumStats, error) {
	ctx, q, args := utm.analyzer.selectByAttribute(filter, FieldUTMMedium)
...
func (utm *UTM) Campaign(filter *Filter) ([]model.UTMCampaignStats, error) {
	ctx, q, args := utm.analyzer.selectByAttribute(filter, FieldUTMCampaign)
