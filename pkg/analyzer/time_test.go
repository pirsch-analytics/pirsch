...
func TestAnalyzer_AvgSessionDuration(t *testing.T) {
	...
	assert.NoError(t, dbClient.SavePageViews([]model.PageView{
		...
		{VisitorID: 1, SessionID: 1, Time: util.Today().Add(time.Second * 25), Path: "/foo", DurationSeconds: 25},
		{VisitorID: 1, SessionID: 1, Time: util.Today().Add(time.Second * 28), Path: "/bar", DurationSeconds: 3},
		{VisitorID: 2, SessionID: 2, Time: util.Today(), Path: "/"},
		{VisitorID: 2, SessionID: 2, Time: util.Today().Add(time.Second * 5), Path: "/foo", DurationSeconds: 5},
		{VisitorID: 3, SessionID: 3, Time: util.Today(), Path: "/"},
		{VisitorID: 4, SessionID: 4, Time: util.Today(), Path: "/"},
		...
		{VisitorID: 5, SessionID: 5, Time: util.Today().Add(time.Second * 2), Path: "/bar", DurationSeconds: 2},
		{VisitorID: 6, SessionID: 6, Time: util.Today(), Path: "/"},
	}))
	...
	assert.Equal(t, 18, stats[0].AverageTimeSpentSeconds) // average is (28+5+35+2)/4 because bounced visitors are not taken into the calculation
...
func TestAnalyzer_AvgTimeOnPage(t *testing.T) {
	...
	assert.NoError(t, dbClient.SavePageViews([]model.PageView{
		{VisitorID: 1, Time: time.Date(2023, 10, 22, 0, 0, 0, 0, time.UTC), SessionID: 3, Path: "/", Title: "Home"},
		...
		{VisitorID: 2, Time: time.Date(2023, 10, 22, 0, 0, 0, 0, time.UTC), SessionID: 3, Path: "/", Title: "Home"},
		...
		{VisitorID: 3, Time: time.Date(2023, 10, 23, 0, 0, 0, 0, time.UTC), SessionID: 2, Path: "/", Title: "Home"},
		...
		{VisitorID: 4, Time: time.Date(2023, 10, 23, 0, 0, 0, 0, time.UTC).Add(time.Second * 4), SessionID: 2, Path: "/foo", DurationSeconds: 4, Title: "Foo"},
		{VisitorID: 5, Time: time.Date(2023, 10, 24, 0, 0, 0, 0, time.UTC), SessionID: 1, Path: "/", Title: "Home"},
		...
		{VisitorID: 6, Time: time.Date(2023, 10, 24, 0, 0, 0, 0, time.UTC), SessionID: 1, Path: "/", Title: "Home"},
		{VisitorID: 6, Time: time.Date(2023, 10, 24, 0, 0, 0, 0, time.UTC).Add(time.Second * 6), SessionID: 1, Path: "/foo", DurationSeconds: 6, Title: "Foo"},
	}))
	time.Sleep(time.Millisecond * 20)
	analyzer := NewAnalyzer(dbClient)
