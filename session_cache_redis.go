...
func (cache *SessionCacheRedis) Get(clientID uint64, fingerprint string, maxAge time.Time) *Hit {
...
func (cache *SessionCacheRedis) Put(clientID uint64, fingerprint string, hit *Hit) {
