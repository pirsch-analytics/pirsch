...
func TestAnalyzer_VisitorsAvgSessionDurationAvgTimeOnPagePeriod(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Len(t, visitors, 5)
	assert.Equal(t, pastWeek(5), getWeek(visitors[0].Week.Time))
	assert.Equal(t, pastWeek(4), getWeek(visitors[1].Week.Time))
	assert.Equal(t, pastWeek(3), getWeek(visitors[2].Week.Time))
	assert.Equal(t, pastWeek(2), getWeek(visitors[3].Week.Time))
	assert.Equal(t, pastWeek(1), getWeek(visitors[4].Week.Time))
	...
	assert.NoError(t, err)
	assert.Len(t, asd, 5)
	assert.Equal(t, pastWeek(5), getWeek(asd[0].Week.Time))
	assert.Equal(t, pastWeek(4), getWeek(asd[1].Week.Time))
	assert.Equal(t, pastWeek(3), getWeek(asd[2].Week.Time))
	assert.Equal(t, pastWeek(2), getWeek(asd[3].Week.Time))
	assert.Equal(t, pastWeek(1), getWeek(asd[4].Week.Time))
	...
	assert.NoError(t, err)
	assert.Len(t, atop, 5)
	assert.Equal(t, pastWeek(5), getWeek(atop[0].Week.Time))
	assert.Equal(t, pastWeek(4), getWeek(atop[1].Week.Time))
	assert.Equal(t, pastWeek(3), getWeek(atop[2].Week.Time))
	assert.Equal(t, pastWeek(2), getWeek(atop[3].Week.Time))
	assert.Equal(t, pastWeek(1), getWeek(atop[4].Week.Time))
	...
	assert.NoError(t, err)
	assert.Len(t, visitors, 5)
	assert.Equal(t, pastMonth(4), visitors[0].Month.Time)
	assert.Equal(t, pastMonth(3), visitors[1].Month.Time)
	assert.Equal(t, pastMonth(2), visitors[2].Month.Time)
	assert.Equal(t, pastMonth(1), visitors[3].Month.Time)
	assert.Equal(t, pastMonth(0), visitors[4].Month.Time)
	...
	assert.NoError(t, err)
	assert.Len(t, asd, 5)
	assert.Equal(t, pastMonth(4), asd[0].Month.Time)
	assert.Equal(t, pastMonth(3), asd[1].Month.Time)
	assert.Equal(t, pastMonth(2), asd[2].Month.Time)
	assert.Equal(t, pastMonth(1), asd[3].Month.Time)
	assert.Equal(t, pastMonth(0), asd[4].Month.Time)
	...
	assert.NoError(t, err)
	assert.Len(t, atop, 5)
	assert.Equal(t, pastMonth(4), atop[0].Month.Time)
	assert.Equal(t, pastMonth(3), atop[1].Month.Time)
	assert.Equal(t, pastMonth(2), atop[2].Month.Time)
	assert.Equal(t, pastMonth(1), atop[3].Month.Time)
	assert.Equal(t, pastMonth(0), atop[4].Month.Time)
