...
func TestAnalyzer_PageVisitors(t *testing.T) {
	...
	for _, tenantID := range tenantIDs {
		...
		assert.Equal(t, "/path", visitors[1].Path)
		...
		assert.Equal(t, 0, visitors[0].Stats[1].Visitors)
		...
		assert.Equal(t, 42, visitors[1].Stats[1].Visitors)
		...
		assert.Equal(t, 0, visitors[0].Stats[1].Sessions)
		...
		assert.Equal(t, 67, visitors[1].Stats[1].Sessions)
		...
		assert.Equal(t, 0, visitors[0].Stats[1].Bounces)
		...
		assert.Equal(t, 30, visitors[1].Stats[1].Bounces)
		...
		assert.InDelta(t, 0, visitors[0].Stats[1].RelativeVisitors, 0.01)
		assert.InDelta(t, 0, visitors[0].Stats[2].RelativeVisitors, 0.01)
		assert.InDelta(t, 1, visitors[0].Stats[3].RelativeVisitors, 0.01)
		assert.InDelta(t, 0, visitors[1].Stats[0].RelativeVisitors, 0.01)
		assert.InDelta(t, 0.9767, visitors[1].Stats[1].RelativeVisitors, 0.01)
		assert.InDelta(t, 0, visitors[1].Stats[2].RelativeVisitors, 0.01)
		assert.InDelta(t, 0.0232, visitors[1].Stats[3].RelativeVisitors, 0.01)
		assert.InDelta(t, 0, visitors[0].Stats[0].BounceRate, 0.01)
		assert.InDelta(t, 0, visitors[0].Stats[1].BounceRate, 0.01)
		...
		assert.InDelta(t, 0.71, visitors[1].Stats[1].BounceRate, 0.01)
