...
func TestGet(t *testing.T) {
	input := []struct {
		...
		{"https://t.co/asdf", nil, false},
		{"https://t.co", nil, false},
		{"HTTPS://T.CO", nil, false},
	}
	expected := []struct {
		referrer string
	...
	for i, in := range input {
		...
		referrer, referrerName, _ := Get(r, "", in.blacklist, in.ignoreSubdomain)
