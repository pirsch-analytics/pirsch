...
func (analyzer *Analyzer) ActiveVisitors(filter *Filter, duration time.Duration) ([]model.ActiveVisitorStats, int, error) {
...
func (analyzer *Analyzer) TotalVisitors(filter *Filter) (*model.TotalVisitorStats, error) {
...
func (analyzer *Analyzer) Visitors(filter *Filter) ([]model.VisitorStats, error) {
	filter = analyzer.getFilter(filter)
...
func (analyzer *Analyzer) Growth(filter *Filter) (*model.Growth, error) {
	filter = analyzer.getFilter(filter)
...
func (analyzer *Analyzer) VisitorHours(filter *Filter) ([]model.VisitorHourStats, error) {
	args, query := analyzer.getFilter(filter).buildQuery([]Field{
		FieldHour,
		FieldVisitors,
		FieldSessions,
...
func (analyzer *Analyzer) Pages(filter *Filter) ([]model.PageStats, error) {
	filter = analyzer.getFilter(filter)
	fields := []Field{
		FieldPath,
		FieldVisitors,
...
func (analyzer *Analyzer) EntryPages(filter *Filter) ([]model.EntryStats, error) {
	filter = analyzer.getFilter(filter)
...
func (analyzer *Analyzer) ExitPages(filter *Filter) ([]model.ExitStats, error) {
	filter = analyzer.getFilter(filter)
...
func (analyzer *Analyzer) Events(filter *Filter) ([]model.EventStats, error) {
	filter = analyzer.getFilter(filter)
...
func (analyzer *Analyzer) EventList(filter *Filter) ([]model.EventListStats, error) {
	filter = analyzer.getFilter(filter)
	filter.eventFilter = true
	args, query := filter.buildQuery([]Field{
		FieldEventName,
...
func (analyzer *Analyzer) Referrer(filter *Filter) ([]model.ReferrerStats, error) {
	filter = analyzer.getFilter(filter)
	fields := []Field{
		FieldReferrerName,
		FieldReferrerIcon,
...
func (analyzer *Analyzer) Platform(filter *Filter) (*model.PlatformStats, error) {
	filter = analyzer.getFilter(filter)
	table := filter.table()
	var args []any
	query := ""
...
func (analyzer *Analyzer) Languages(filter *Filter) ([]model.LanguageStats, error) {
...
func (analyzer *Analyzer) Countries(filter *Filter) ([]model.CountryStats, error) {
...
func (analyzer *Analyzer) Cities(filter *Filter) ([]model.CityStats, error) {
...
func (analyzer *Analyzer) Browser(filter *Filter) ([]model.BrowserStats, error) {
...
func (analyzer *Analyzer) OS(filter *Filter) ([]model.OSStats, error) {
...
func (analyzer *Analyzer) ScreenClass(filter *Filter) ([]model.ScreenClassStats, error) {
...
func (analyzer *Analyzer) UTMSource(filter *Filter) ([]model.UTMSourceStats, error) {
...
func (analyzer *Analyzer) UTMMedium(filter *Filter) ([]model.UTMMediumStats, error) {
...
func (analyzer *Analyzer) UTMCampaign(filter *Filter) ([]model.UTMCampaignStats, error) {
...
func (analyzer *Analyzer) UTMContent(filter *Filter) ([]model.UTMContentStats, error) {
...
func (analyzer *Analyzer) UTMTerm(filter *Filter) ([]model.UTMTermStats, error) {
...
func (analyzer *Analyzer) OSVersion(filter *Filter) ([]model.OSVersionStats, error) {
	args, query := analyzer.getFilter(filter).buildQuery([]Field{
		FieldOS,
		FieldOSVersion,
		FieldVisitors,
...
func (analyzer *Analyzer) BrowserVersion(filter *Filter) ([]model.BrowserVersionStats, error) {
	args, query := analyzer.getFilter(filter).buildQuery([]Field{
		FieldBrowser,
		FieldBrowserVersion,
		FieldVisitors,
...
func (analyzer *Analyzer) AvgSessionDuration(filter *Filter) ([]model.TimeSpentStats, error) {
	filter = analyzer.getFilter(filter)
...
func (analyzer *Analyzer) AvgTimeOnPage(filter *Filter) ([]model.TimeSpentStats, error) {
	filter = analyzer.getFilter(filter)
...
func (analyzer *Analyzer) totalVisitorsSessions(filter *Filter, paths []string) ([]model.TotalVisitorSessionStats, error) {
	if len(paths) == 0 {
...
func (analyzer *Analyzer) avgTimeOnPage(filter *Filter, paths []string) ([]model.AvgTimeSpentStats, error) {
	if len(paths) == 0 {
